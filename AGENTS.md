# cpp-live-transcription

C++ (Crow) demo app for Deepgram Live Transcription.
...
```
feat(cpp-live-transcription): add diarization support
fix(cpp-live-transcription): resolve WebSocket close handling
refactor(cpp-live-transcription): simplify session endpoint
